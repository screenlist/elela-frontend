          ...
          {:else}
            ...
            <div class="stats stats-vertical shadow">
              <div class="stat">
                ...
                <div class="stat-value">{pricingData.calls.minutes} mins</div>
              </div>
              ...
              <div class="stat">
                ...
                <div class="stat-value">{pricingData.storage.storage} GB</div>
              </div>
              ...
              <div class="stat">
                ...
                <div class="stat-value">{pricingData.storage.downloads} GB</div>
              </div>
            </div>
          {/if}
        </div>
